...
urlpatterns = [
    ...
    # URLs de Categorias (Mantidas ou ajustadas para sua preferência, se houver)
    # Supondo que você queira manter o padrão de 'lista', 'adicionar', 'editar', 'deletar'
    path('categorias/', views.lista_categorias_view, name='lista_categorias'), # Mudei aqui
    path('categorias/novo/', views.categoria_form_view, name='categoria_novo'), # Mudei aqui
    path('categorias/<int:pk>/editar/', views.categoria_form_view, name='categoria_editar'),
    path('categorias/<int:pk>/deletar/', views.categoria_delete_view, name='categoria_deletar'), # Mantido do meu anterior
    ...
    path('produtos/<int:pk>/deletar/', views.produto_delete_view, name='produto_deletar'), # Adicionado para consistência
    
    # URLs de Venda
    path('vendas/', views.lista_vendas_view, name='lista_vendas'),
    path('vendas/nova/', views.venda_form_view, name='venda_nova'),
    path('vendas/<int:pk>/editar/', views.venda_form_view, name='venda_editar'), # Adicionado para consistência
    path('vendas/<int:pk>/deletar/', views.venda_delete_view, name='venda_deletar'), # Adicionado para consistência
    ...
    path('clientes/<int:pk>/deletar/', views.cliente_delete_view, name='cliente_deletar'), # Adicionado para consistência
    ...
    path('fornecedores/<int:pk>/deletar/', views.fornecedor_delete_view, name='fornecedor_deletar'), # Adicionado para consistência
    ...
    path('contas-a-pagar/<int:pk>/deletar/', views.conta_pagar_delete_view, name='conta_pagar_deletar'), # Adicionado para consistência
    ...
    path('contas-a-receber/<int:pk>/deletar/', views.conta_receber_delete_view, name='conta_receber_deletar'), # Adicionado para consistência
